...
export let useTableForm: typeof useXAppForm;
...
export function setupXAppVxeTable(setupOptions: SetupVxeTable) {
  const { configVxeTable, useXAppForm } = setupOptions;

  initVxeTable();
  useTableForm = useXAppForm;
