...
import type { DropdownMenuProps } from '@x-monorepo-core/shadcn-ui';

import { ChevronDown } from '@x-monorepo-core/icons';
import { VbenDropdownMenu } from '@x-monorepo-core/shadcn-ui';
