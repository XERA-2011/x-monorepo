    ...
    <div class="grid grid-cols-1 gap-10 lg:grid-cols-2">
      ...
      >
        ...
        >
          ...
          ></div>
          <div
            class="relative mb-8 aspect-square overflow-hidden border-2 border-[#2D1B4E] bg-[#1a103c]"
          >
            <div
              class="absolute inset-0 bg-gradient-to-br from-[#FF00FF]/10 to-[#00FFFF]/10"
            ></div>
            <img
              alt="StarterApp"
          ...
          <div class="space-y-4">
            ...
            <p class="min-h-[5rem] text-base leading-relaxed text-[#E0E0E0]/60">
              ...
              so your MVP starts where most products finish.
            </p>
          </div>
          <div
          ...
          >
            ...
            <div
              class="h-px flex-1 bg-gradient-to-r from-[#FF00FF] to-transparent"
            ></div>
          </div>
        </div>
        <div
